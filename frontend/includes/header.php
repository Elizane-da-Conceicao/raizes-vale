...
<nav id="header">
    ...
    <a href="<?php echo $validacoes; ?>"> <img class="icon-nav" src="./assets/img/estralaceita.jpg" alt="Icone arvore">Validações</a>
    ...
    <a href="<?php echo $loginURL; ?>"><img class="icon-nav" src="./assets/img/logout.jpg" alt="Icone arvore"></a>
</nav>
<hr>
